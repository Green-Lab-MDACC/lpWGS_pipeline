#!/bin/bash
Sample_ID= ##Insert Sample Name Here
...
bwa mem -t 4 -R "@RG\tPL:ILLUMINA\tID:${Sample_ID}\tSM:${Sample_ID}" ./data/hg19/genome.fa ./data/${Sample_ID}/${Sample_ID_R1}_P.fastq.gz ./data/${Sample_ID}/${Sample_ID_R2}_P.fastq.gz | samtools view -S -b - > ./data/${Sample_ID}/$Sample_ID.bam
...
#Run CNApp
# Rscript $PWD/programs/CNApp/funs/Ht.Chroms.RegionProfile.R --input $PWD/data/${Sample_ID}/${Sample_ID}.CNApp__input.txt